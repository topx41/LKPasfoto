  ...
  app.post(
    ...
    (req: express.Request, res: express.Response) => {
      try {
        ...
        if (filesObj) {
          file =
            filesObj["excel_file"]?.[0] ||
            filesObj["file"]?.[0] ||
            filesObj["documents"]?.[0];
        }
        ...
        res.send(`
          ...
          <head>
            ...
            <style>
              ...
              .spinner { width: 40px; h-40px; border: 4px solid #1e293b; border-top: 4px solid #38bdf8; border-radius: 50%; animation: spin 0.8s linear infinite; margin: 0 auto 16px auto; }
          ...
          <body>
            <div class="card">
              ...
              <h2>⚡ File Excel Diterima dari WhatsApp!</h2>
              <p>Membuka ${parsedCustomers.length} customer di Foto Studio Manager...</p>
            </div>
            <script>
              try {
                const payload = {
